...
public class GettingUserID extends Activity implements View.OnClickListener {
...
/*        refresh_button = (Button) findViewById(R.id.refresh_button);
    ...
    public void getUsernames() throws Exception {
        ...
        RequestBody formBody = new FormBody.Builder()
                .add("USER_NAME","LiamMar")
                .build();
        //Building our request
        Request request = new Request.Builder()
                .url("http://134.83.83.25:47309/FindUserID")
                .post(formBody)
                .build();
    ...
    private void displayUsernames(String response) {
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                Log.d(TAG, row.getString("USER_ID"));
                usernames.add(row.getString("USER_ID"));
            }
